...
DIST=\
	...
	src/cpuspeedy.py	\
	src/pycpufreq.py	\
	src/pythermalzone.py	\
	src/pycpufreq_api24.py	\
	src/pycpufreq_proc.py	\
	src/pycpufreq_sysfs.py	\
	src/errors.py		\
	src/messages.py		\
	doc/cpuspeedy.1

src/$(PACKAGE): src/$(PACKAGE).py
	@# sets the cpuspeedy import dir according to LIBDIR and installs the cpuspeedy script	
